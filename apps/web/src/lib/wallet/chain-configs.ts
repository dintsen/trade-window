...
/** Explorer account URL builder per chain */
export const EXPLORER_ADDRESS: Record<string, (address: string) => string> = {
  "cosmoshub-4": (address) => `https://www.mintscan.io/cosmos/address/${address}`,
  "stargaze-1": (address) => `https://www.mintscan.io/stargaze/address/${address}`,
  "atomone-1": (address) => `https://explorer.atomone.xyz/atomone/account/${address}`,
  "gno-testnet": (address) => `https://gnoscan.io/accounts/${address}`,
};
