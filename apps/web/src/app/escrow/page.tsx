      ...
      <main className="max-w-4xl w-full mx-auto px-6 flex-1 flex flex-col md:flex-row items-center justify-center gap-16 relative z-10 py-20">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-5xl md:text-6xl font-bold tracking-tighter mb-6 text-white">
            Gno <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-indigo-400">Escrow.</span>
          </h1>
          
          <p className="text-lg text-white/50 font-light mb-8 leading-relaxed">
            A tested Gno.land escrow state machine for intent-hash deals: both sides mark funding, both approve release, and a guarantor can resolve disputes. Mainnet custody remains disabled until deployment and audit.
          </p>

          <ul className="space-y-4 mb-10">
            {['Dual-party release approval', 'Bundle escrow by deterministic intent hash', 'Guarantor dispute refund or release path'].map((feature, i) => (
          ...
          <Link href="/trade" className="px-8 py-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 text-white font-semibold transition-all inline-flex items-center gap-2 group">
            Open Trade Room <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
          </Link>
        </div>
        ...
        <div className="flex-1 w-full max-w-sm relative group perspective-[1000px]">
          ...
          <div className="relative bg-[#0a0a0c]/80 backdrop-blur-2xl border border-white/10 hover:border-emerald-500/30 rounded-[2rem] p-1 shadow-2xl transform transition-all duration-700 hover:-translate-y-4 hover:rotate-y-[-5deg] hover:rotate-x-[5deg] shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden">
            ...
            <div className="relative bg-[#050507] rounded-[1.8rem] p-10 h-full w-full flex flex-col items-center justify-center text-center overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-white mb-2 tracking-tight">Escrow Realm</h3>
              
              <div className="flex items-center gap-2 mb-8 px-4 py-1.5 rounded-full bg-white/5 border border-white/10">
                <span className="w-1.5 h-1.5 rounded-full bg-indigo-400 animate-pulse"></span>
	                <span className="text-[11px] font-mono text-white/50 uppercase tracking-widest">Local Tests Passing</span>
              </div>
              ...
              <div className="w-full">
                ...
                <div className="w-full h-2 bg-[#111] rounded-full overflow-hidden border border-white/5 relative">
	                  <div className="absolute top-0 left-0 h-full w-[82%] bg-gradient-to-r from-indigo-500 to-emerald-400 rounded-full shadow-[0_0_10px_rgba(16,185,129,0.5)]">
