...
export default function Error({
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-white flex flex-col items-center justify-center p-6 text-center font-sans">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-rose-500/10 blur-[150px] rounded-full pointer-events-none"></div>
      ...
      <div className="relative z-10 max-w-md w-full bg-[#0a0a0a] border border-white/5 rounded-2xl p-10 shadow-2xl">
        ...
        <p className="text-white/50 text-sm mb-8">
          A runtime error occurred in the React application.
        </p>
